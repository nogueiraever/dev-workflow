...
- Cross-reference `tasks.md` to confirm all tasks are truly `done`
- Check that the implementation matches the approved `plan.md` scope
...
- Follow-up tasks generated in `tasks.md` (if gaps found)
