...
Validate the implementation against acceptance criteria and plan. Identify gaps before declaring the feature complete. If gaps are found, generate follow-up tasks and return to execution.
...
- Were any files modified that aren't related to the feature?
...
**If gaps found:**
- For each gap, create a follow-up task in `tasks.md`:
...
- Update `tasks.md` frontmatter (total_tasks increases)
